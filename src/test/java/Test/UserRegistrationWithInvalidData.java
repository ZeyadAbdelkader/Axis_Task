...
public class UserRegistrationWithInvalidData extends BaseTest {
    ...
    {
        ctx.setAttribute(method.getName(), "Verify that User Can't Register With Invalid Password");
    ...
    public void RegisterWithInValidPassword(UserRegistration data) {
        ...
        softAssert.assertEquals(data.getMessages(), registrationPage.CheckErrorMessage());
